...
<body>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            ...
                            &nbsp;
                            <a style="float: right;" href="javascript:;">当前用户:&nbsp;<?php echo ($student_name); ?></a>
                            <!---->
                        </li>
  ...
  <ol class="breadcrumb" style="background-color:#FFFFFF;">
    <li><a href="/CPS/index.php/Student/Stu/course_info/student_id/<?php echo ($student_id); ?>">课程信息</a></li>
    <li><a href="/CPS/index.php/Student/Stu/myproject/student_id/<?php echo ($student_id); ?>">我的课题</a></li>
    <li><a href="/CPS/index.php/Student/Stu/myteam/student_id/<?php echo ($student_id); ?>">我的队伍</a></li>
    <li><a href="/CPS/index.php/Student/Stu/team_manage/student_id/<?php echo ($student_id); ?>">队伍管理</a></li>
  </ol>
  </div>
    <!DOCTYPE html>
<html>
