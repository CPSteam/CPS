	...
	<div style="width: 1080px; margin: 0 auto;">
		<table class="table table-bordered table table-striped text-center">
			...
			<?php if(is_array($report)): foreach($report as $key=>$h): ?><tr>
					...
					<!-- <td>xx</td> -->
					<td><?php echo ($h["group_middle_report_score"]); ?></td>
					<td>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div style="margin-left: 200px;">
					...
					<input type="text" class="form-control" id="project_name" style="width: 200px;" value="<?php echo ($v["course_name"]); ?>">
					<label>课题名称
					</label>
					<input type="text" class="form-control" id="report_file" style="width: 200px;" value="<?php echo ($v["project_name"]); ?>">
					<label>报告文件
					</label>
					<input type="file" id="inputfile">
					<br>
					<button type="button" class="btn btn-info"
					style="margin-left:15%;">确定</button>
				</div>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal -->
